...
public interface IServiceScreen extends INgnBaseService {
	boolean back();
	...
	boolean show(Class<? extends Activity> cls, Bundle params);
	
	boolean showPersonOrOrgInfo(Class<? extends Activity> cls, String id);//显示个人和组织页面
