...
public class CustomDialog {
	...
	public static void show(Context context, int icon, String title,
		...
		ImageView ivIcon = (ImageView) layout
				.findViewById(R.id.custom_dialog_imageView_icon);
		ivIcon.setImageResource(icon);
		TextView tvTitle = (TextView) layout
				.findViewById(R.id.custom_dialog_textView_title);
		tvTitle.setText((title == null) ? "" : title);
		TextView tvMsg = (TextView) layout
				.findViewById(R.id.custom_dialog_textView_msg);
		tvMsg.setText(msg);
