...
public class ScreenNatt extends BaseScreen {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mRlEnableStun.setVisibility(mCbEnableStun.isChecked() ? View.VISIBLE
				: View.INVISIBLE);
		mRlStunServer.setVisibility(mRbSetStun.isChecked() ? View.VISIBLE
				: View.INVISIBLE);
		...
		mRbSetStun
				.setOnCheckedChangeListener(mRbSetStun_OnCheckedChangeListener);
	}
	...
	private OnCheckedChangeListener mCbEnableStun_OnCheckedChangeListener = new OnCheckedChangeListener() {
		...
		public void onCheckedChanged(CompoundButton buttonView,
				boolean isChecked) {
			mRlEnableStun.setVisibility(isChecked ? View.VISIBLE
					: View.INVISIBLE);
