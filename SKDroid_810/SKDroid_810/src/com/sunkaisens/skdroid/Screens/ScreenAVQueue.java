...
public class ScreenAVQueue extends BaseScreen {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				final NgnAVSession session = (NgnAVSession) mAdapter
						.getItem(position);
				if (session != null) {
	...
	public boolean createOptionsMenu(Menu menu) {
		menu.add(0, MENU_HANGUP_ALLCALLS, 0, "挂断所有电话").setIcon(
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		menu.add(0, MENU_OPEN_CALL, Menu.NONE, "打开");
		menu.add(0, MENU_HANGUP_CALL, Menu.NONE, "挂断");
	}
	...
	private void resumeAVSession(NgnAVSession session) {
		...
		final NgnAVSession activeSession = NgnAVSession
				.getFirstActiveCallAndNot(session.getId());
