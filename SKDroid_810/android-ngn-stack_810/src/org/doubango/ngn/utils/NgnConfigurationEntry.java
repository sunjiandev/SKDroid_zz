...
public class NgnConfigurationEntry {
	...
	/**
	 * ͨ����ʷ��¼�ͼ�ʱ��Ϣ��ʷ��¼ʱ����ʽ  true��12Сʱ��   false��24Сʱ��
	 */
...
//	public static final boolean DEFAULT_GENERAL_FULL_SCREEN_VIDEO = true;
	public static final boolean DEFAULT_GENERAL_FULL_SCREEN_VIDEO = false; //Ĭ�����÷���Ƶͨ��ȫ��ģʽ
...
//	public static final boolean DEFAULT_GENERAL_USE_FFC = true;
	public static final boolean DEFAULT_GENERAL_USE_FFC = false; //Ĭ�����ò�����ǰ������ͷģʽ
	...
	// Network
	public static final int DEFAULT_NETWORK_REGISTRATION_TIMEOUT = 30; //1700 ע��ˢ��ʱ������
...
//	public static final String DEFAULT_NATT_STUN_SERVER = "numb.viagenie.ca";
    ...
    public static final int DEFAULT_QOS_SIP_CALLS_TIMEOUT = 120;    //������Ϣˢ��ע������
...
//    public static String DEFAULT_QOS_PREF_VIDEO_SIZE = tmedia_pref_video_size_t.tmedia_pref_video_size_skd.toString(); //�Զ��� skd (512 x 288)
...
//	public static final String DEFAULT_XCAP_USERNAME = "sip:johndoe@doubango.org";
	...
	public static final String XCAP_GroupContacts_For_Single = "XCAP_GroupContacts_For_Single." + TAG;  //�洢�ӷ��������ص�(����)ͨ��¼���� 
	public static final String XCAP_GroupContacts_For_Group = "XCAP_GroupContacts_For_Group." + TAG;  //�洢�ӷ��������ص�(��)ͨ��¼���� 
	...
	//by rockman 2012/9/26
	public static final String DEFAULT_XCAP_GroupContacts_For_Single = null;  //�洢�ӷ��������ص�(����)ͨ��¼���� 
	public static final String DEFAULT_XCAP_GroupContacts_For_Group = null + TAG;  //�洢�ӷ��������ص�(��)ͨ��¼���� 
...
//	public static final String DEFAULT_MAP_SERVER_URL = "170.1.1.100:8080/GIS_lhr";
	...
	//Gps Report Period
	public static final String GPS_REPORT_PERIOD = "5"; //��λ����
	
	public static final int AUDIO_HEARDBEAT_PERIOD = 15000; //��λ����
